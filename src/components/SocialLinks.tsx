// Barra compacta de anuncio e íconos, arriba de todo en el layout
export function SocialBarTop() {
  return (
    <div className="social-bar-top">
      <div className="social-bar-announcement">
        <span>✨ 100% Calidad Garantizada</span> · Venta Mayorista y Minorista
      </div>
